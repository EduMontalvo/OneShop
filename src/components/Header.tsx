...
export default function Header() {
    ...
    return (
        <header className="bg-fondo border-b border-white/5 px-6 py-4 sticky top-0 z-50">
            <div className="max-w-6xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a href="https://wa.me/51XXXXXXXXX"
                        target="_blank"
                    ...
                    <button
                        className="md:hidden text-texto-secundario hover:text-texto transition-colors"
            ...
            {menuAbierto && (
                <nav className="md:hidden border-t border-white/5 mt-4 pt-4 flex flex-col gap-4">
                    {navLinks.map((link) => (
                        <Link
                            key={link.path}
                            to={link.path}
